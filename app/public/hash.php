<?php
echo password_hash('tonMotDePasse', PASSWORD_DEFAULT); // <-- juste ici a la place 
...
UPDATE users SET users_password = 'ICI TU COLLE LE MOT DE PASSE HASHER QUE TU AS COPIER PRECEDEMENT' WHERE users_email = 'test@test.com'; 
