...
class CategorieController
{
    ...
    {
        $this->categorie = new CategorieClass();
    }
    ...
    public function getAllCategories()
    {
        ...
        if ($categories) {
            include __DIR__ . '/../views/categorie/allCategories.php'; //a changer
        } else {
    ...
    //UPDATE & CREATE ----> Gère la modification ou la création d'une catégorie
    public function manageCategorie($categorie_slug = null)
    {
        ...
        if ($categorie_slug) {
            ...
            $categorieData = new CategorieClass();
        ...
        // Appel de la vue
        include 'app/views/categorie/categorieForm.php'; //a changer
    }
}
?>